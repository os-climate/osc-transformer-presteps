...
def run_kpi_curator(annotation_folder: str, agg_annotation: str,
                extracted_text_json_folder: str,
                output_folder: str, kpi_mapping_file: str,
                relevance_file_path: str,
                val_ratio: float, find_new_answerable: bool = True,
                create_unanswerable: bool = True) -> None:
    """
    ...
    try:
        ...
        train_df, val_df = curate(annotation_folder, agg_annotation,
                                  extracted_text_json_folder, kpi_mapping_file,
                                  relevance_file_path, val_ratio,
                                  find_new_answerable, create_unanswerable)
